...
function fail(reason, fieldPath) {
  console.log("owner policy decision matrix self-test failed");
...
function assertSafeOutput(text) {
  ...
  const forbidden = [
    ...
    { reason: "raw-owner-values-output", regex: /raw owner values|raw owner json|raw issue body/i },
  ];
...
for (const expected of [
  "VGC-FUNKY-TOKEN owner policy decision matrix",
...
console.log("owner policy decision matrix self-tests passed");
